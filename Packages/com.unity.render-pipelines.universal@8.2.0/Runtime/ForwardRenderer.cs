        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (lastCameraInTheStack)
            {
                ...
                if (applyPostProcessing)
                {
                    ...
                    m_PostProcessPass.Setup(cameraTargetDescriptor, m_ActiveCameraColorAttachment, destination, m_ActiveCameraDepthAttachment, m_ColorGradingLut, m_BloomMask, applyFinalPostProcessing, doSRGBConvertion);
            ...
            {
                m_PostProcessPass.Setup(cameraTargetDescriptor, m_ActiveCameraColorAttachment, m_AfterPostProcessColor, m_ActiveCameraDepthAttachment, m_ColorGradingLut, m_BloomMask, false, false);
                EnqueuePass(m_PostProcessPass);
            }
